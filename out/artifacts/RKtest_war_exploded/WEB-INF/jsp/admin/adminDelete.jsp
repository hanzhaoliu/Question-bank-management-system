...
<body background="img/6.jpg" style="background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%;">
<%
...
<div style="float: left; border-collapse: separate; border-spacing:20px 0px; width: 100%">
    ...
    <input id="deleteButton" style="font-size: 18px;" type="button" disabled="true" value="删除题目"/>
</div>
    ...
    <table style="margin: 0 auto; border-collapse:separate; border-spacing:0px 10px;">
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;&nbsp;&nbsp;
                <input id="qButton1" style="font-size: 18px;" type="button" value="删除"/>
                &nbsp;&nbsp;&nbsp;
...
<script>
    ...
    $("#qButton1").mousedown(function () {
        $.ajax({
                url : "${pageContext.request.contextPath }/deleteQuestion?qid="+qid,
                type : "post",
