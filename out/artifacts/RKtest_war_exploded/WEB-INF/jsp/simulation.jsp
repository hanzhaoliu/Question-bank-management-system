...
<head lang="en">
    ...
    <script>
        ...
        $(function(){
            ...
            $.ajax({
                url : "${pageContext.request.contextPath }/getQuestionToNum?num=75",
                type : "post",
                async : false,
                //成功响应的结果
            ...
            $("#submitQuestions").click(function(){
                ...
                for(var i=0; i<checkQues.length; ++i){
                    ...
                    var url = 'qid='+checkQues[i].qid+'&qanswer='+(num);
                    //alert(url);
                    $.ajax({
                ...
                url = 'uid='+uid+"&tgrade="+trueNum;
                $.ajax({
                    url : "${pageContext.request.contextPath }/insertTest?"+url,
                    type : "post",
                    async : false,
                    //成功响应的结果
                    success : function(data) {
                ...
                alert("已做答:"+(allNum)+"道题,正确："+trueNum+"道");
